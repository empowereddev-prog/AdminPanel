...
<head>
    ...
    <title>Payment History | Invoice : {{ $data->subscription_type_id }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Invoice: {{ $data->subscription_type_id }}</p>
        ...
        <div class="content">
            <table>
                ...
                <!-- <tr>
                    ...
                    <td>{{ ucfirst($data->plan) ?? 'N/A' }}</td>
                </tr> -->
                <tr>
                    <td><strong>Plan Type</strong></td>
                    <td>{{ ucfirst($data->subscription_type) ?? 'N/A' }}</td>
                </tr>
                <!-- <tr>
                    <td><strong>Device Type</strong></td>
                    <td>{{ ucfirst($data->device_type) ?? 'N/A' }}</td>
                </tr> -->
                <tr>
        ...
        <div class="footer">
        {{-- <p>&copy; {{ date('Y') }} AE Note. All rights reserved.</p> --}}
        </div>
    </div>
</body>
