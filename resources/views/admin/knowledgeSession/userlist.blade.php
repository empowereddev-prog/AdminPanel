        ...
        <div class="content">
            ...
            <div class="card card-default faq">
                <div class="title_left">
                    <h3>Article Like, Dislike & Favourite User List</h3>
                </div>
                ...
                <div class="card-head mb-2">
                    ...
                    <a href="{{ route('knowledgeSession.index') }}" class="btn btn-outline-secondary btn-sm" title="Go Back">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function loadTable(type = 'all') {
                var url = "{{ route('article-user-like.index', ':id') }}".replace(':id', articleId);
