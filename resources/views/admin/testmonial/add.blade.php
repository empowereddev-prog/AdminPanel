            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form id="bannerForm" action="{{ route('testimonial.store') }}" enctype="multipart/form-data" method="post">
                                @csrf
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="review" value="{{old('review')}}" class="review" placeholder="Type your content Here"></textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="zh_CN_review" value="{{old('zh_CN_review')}}" class="review" placeholder="Type your content Here"></textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="zh_TW_review" value="{{old('zh_TW_review')}}" class="review" placeholder="Type your content Here"></textarea>
