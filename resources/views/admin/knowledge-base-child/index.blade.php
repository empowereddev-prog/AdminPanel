    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="title_left">
                <h2>Child Video & Webinars </h2>
            </div>
            <div class="card card-default faq">
                {{-- <div class="card-head mb-2">
                    @if (!empty($pre) && $pre->is_modify == 'yes')
                        <a href="{{ route('knowledge-base-child.create') }}" class="btn btn-pill btn-primary">Add Video & Webinars</a>
                    @endif
                </div> --}}
                <div class="card-head mb-2 d-flex">
                    @if (!empty($pre) && $pre->is_modify == 'yes')
                        <a href="{{ route('knowledge-base-child.create') }}" class="btn btn-pill btn-primary me-2">Add Video
                            & Webinars</a>
                    @endif
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var dataTable = $('#user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('knowledge-base-child.data') }}",
                    type: 'GET',
                    data: function(d) {
