    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="title_left">
                <h2>Add Child Video & Webinars</h2>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="admin-breadcrumb">
                        <li>
                            <a href="{{ route('knowledge-base-child.index') }}">Video & Webinars</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-default">
                        {{-- Preserved your raw page-loader HTML component unchanged --}}
                        <div id="page-loader"
                        ...
                        <div class="card-body">
                            <form id="knowledgeForm" action="{{ route('knowledge-base-child.store') }}"
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                ...
                                                {{-- Added explicit description id mapping to solve editor crashes --}}
                                ...
                                {{-- Actions Container Synchronized with the Real-time Upload Progress Bar Wrapper --}}
