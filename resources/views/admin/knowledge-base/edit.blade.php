    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="title_left">
                <h2>Edit Parent Video Content</h2>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="admin-breadcrumb">
                        <li>
                            <a href="{{ route('knowledge-base.index') }}">Video Content</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-default">
                        <div class="card-body">
                            <form id="knowledgeForm" action="{{ route('knowledge-base.update', $data->id) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6" id="ageRangeWrapper">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control point" name="points" id="points"
                                                    placeholder="Enter Points" value="{{ $data->points ?? '' }}">
                                                @error('points')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                ...
                                                {{-- Added explicit descriptor id element to steady target text fields inside CKEditor configurations --}}
            ...
            $('#knowledgeForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        showToast((res && res.message) || 'Video resource updated successfully!', 'success');
