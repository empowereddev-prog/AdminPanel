    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="title_left">
                <h2>Add Parent Video & Webinars</h2>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="admin-breadcrumb">
                        <li>
                            <a href="{{ route('knowledge-base.index') }}">Video & Webinars</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-default">
                        {{-- Preserved original loader container layout structure safely --}}
                        <div id="page-loader"
                        ...
                        <div class="card-body">
                            <form id="knowledgeForm" action="{{ route('knowledge-base.store') }}"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3" id="ageRangeWrapper">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control select2" name="school_id[]" id="school_id" multiple>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                ...
                                                {{-- Added specific ID descriptor for complete CKEditor mapping security --}}
                                ...
                                {{-- Actions Container Coupled with real-time progress bar layout elements --}}
                                <div class="form-footer text-end">
                                    ...
                                    <a href="{{ route('knowledge-base.index') }}" class="btn btn-primary btn-pill mr-2">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function formatState(state) {
                ...
                let isChecked = $(state.element).prop('selected') ? "checked" : "";
                return $(
                    '<div class="select2-result-repository clearfix">' +
                        '<input type="checkbox" ' + isChecked + ' style="margin-right: 10px;">' +
            ...
            $('#school_id').on('select2:select select2:unselect', function (e) {
                ...
                if (data.id === 'all') {
                    if (e.type === 'select2:select') {
                        let allValues = $element.find('option').map(function() {
                            return $(this).val();
                        }).get();
            ...
            // Real-time Upload Performance Progression Processing Engine with validation checkpoints
            $('#knowledgeForm').on('submit', function (e) {
                e.preventDefault();
                e.stopPropagation();

                // Frontend validation mapping before triggering multi-threaded binary streaming
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        setTimeout(() => { window.location.href = (res && res.redirect) || "{{ route('knowledge-base.index') }}"; }, 1500);
                    },
                    error: function (xhr) {
                        hideProgress();
                        $btn.prop('disabled', false).text('Submit');
