            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-default">
                        <div class="card-body">
                            <form id="bannerForm" action="{{ route('category.update', $data->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="group_name">Category Name (In Chinese)</label>
                                        <input type="text" class="form-control" name="category_name_chinese"
                                            id="category_name_chinese" placeholder="Enter Category Name"
                                            value="{{$data->category_name_chinese ? $data->category_name_chinese : ''}}" maxlength="100">
