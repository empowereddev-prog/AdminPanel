            ...
            <div class="card card-default faq">
                {{-- <div class="card-head mb-2">
                    @if (!empty($pre) && $pre->is_modify == 'yes')
                        <a href="{{ route('video-other.create') }}" class="btn btn-pill btn-primary">Add Video & Webinars</a>
                    @endif
                </div> --}}
                <div class="card-head mb-2 d-flex">
                    @if (!empty($pre) && $pre->is_modify == 'yes')
                        <a href="{{ route('video-other.create') }}" class="btn btn-pill btn-primary me-2">Add Video
                            & Webinars</a>
                    @endif
